...
| **`compare-schema` index parity (T1 / T2b / T3 / T4)** | [`docs/planning/DESIGN_INDEX_COMPARE_ROADMAP.md`](./docs/planning/DESIGN_INDEX_COMPARE_ROADMAP.md) — **T1**, **T2**, **T4** shipped; **T2b** **partial** (catalog non-default btree opclass vs type default); **T3** **partial** (live expression btree key vs merged simple-column index; **T1** suppressed); **T2b** / **T3** follow-ons optional |
