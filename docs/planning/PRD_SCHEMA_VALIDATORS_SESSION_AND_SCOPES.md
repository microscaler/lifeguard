...
- [x] **PRD follow-on closure (this document):** §5.7a **`compare-schema`** includes access-method drift, **T1**-style normalized index statement text when names match, and index-only-in-DB/migration reporting; **T4** opt-in **`#[require_index_coverage]`** on **`LifeModel`**; §7.7 optional struct scope-list codegen **closed** (use **`#[scope_bundle]`**); §9.7 mapping discipline = **G6**; optional **T2b** / **T3** remain in **[DESIGN_INDEX_COMPARE_ROADMAP.md](./DESIGN_INDEX_COMPARE_ROADMAP.md)** and **[ROADMAP.md](../../ROADMAP.md)**.
...
**Post-PRD (optional):** btree **opclass** tokens (**T2b**), richer expression-key parity (**T3**) — **[DESIGN_INDEX_COMPARE_ROADMAP.md](./DESIGN_INDEX_COMPARE_ROADMAP.md)**, **[ROADMAP.md](../../ROADMAP.md)**.
