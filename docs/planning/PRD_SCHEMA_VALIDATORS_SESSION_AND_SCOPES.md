...
- [x] **PRD follow-on closure (this document):** §5.7a **access-method** check in **`compare-schema`**; §7.7 optional struct scope-list codegen **closed** (use **`#[scope_bundle]`**); §9.7 mapping discipline = **G6**; remaining index / derive items live in **[DESIGN_INDEX_COMPARE_ROADMAP.md](./DESIGN_INDEX_COMPARE_ROADMAP.md)** and **[ROADMAP.md](../../ROADMAP.md)** — not blocking new roadmap work.
...
**Post-PRD (optional):** full **`indexdef`** text (**T1**), btree **opclass** tokens (**T2b**), expression keys (**T3**), derive **field ↔ index** (**T4**) — **[DESIGN_INDEX_COMPARE_ROADMAP.md](./DESIGN_INDEX_COMPARE_ROADMAP.md)**, **[ROADMAP.md](../../ROADMAP.md)**.
