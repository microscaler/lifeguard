...
- **Scopes vs `find_related`:** parent entity **`scope`** predicates are **not** merged into **`find_related`**; chain filters or scopes on the returned **`SelectQuery`**, or use **`FindRelated::find_related_scoped`** ([`query::scope`](./src/query/scope.rs), [`FindRelated`](./src/relation/traits.rs), [DESIGN_FIND_RELATED_SCOPES.md](./docs/planning/DESIGN_FIND_RELATED_SCOPES.md); integration: [`tests/db_integration/related_trait.rs`](./tests/db_integration/related_trait.rs)).
