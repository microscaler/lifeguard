...
pub trait ActiveModelTrait: Clone + Send + std::fmt::Debug {
    ...
    /// }
    /// ```
    /// Get a value dynamically using a column name. Unimplemented by default but generated by macro.
    fn get_col(&self, _col_name: &str) -> Option<Value> {
        None
    }

    /// Set a value dynamically using a column name. Unimplemented by default but generated by macro.
    ...
    fn into_active_value(&self, column: <Self::Entity as LifeModelTrait>::Column) -> ActiveValue {
