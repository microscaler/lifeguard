...
pub trait ActiveModelTrait: Clone + Send + std::fmt::Debug {
    ...
    fn set_col(&mut self, _col_name: &str, _val: Value) -> Result<(), ActiveModelError> {
        Err(ActiveModelError::Other("set_col not implemented".to_string()))
    }
        ...
        Self: Sized,
    {
        ...
        let is_has_many = matches!(def.rel_type, crate::RelationType::HasMany | crate::RelationType::HasOne);
        assert!(is_has_many, "Relation must be HasMany or HasOne for add_child()");
