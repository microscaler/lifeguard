...
pub trait LifeModelTrait: LifeEntityName {
    ...
    type Column: sea_query::IdenStatic;
        ...
        E::Model: FromRow,
    {
        ...
        for value in values.iter() {
            match value {
                ...
                sea_query::Value::Json(Some(j)) => strings.push(serde_json::to_string(&**j).map_err(|e| LifeError::Other(format!("Failed to serialize JSON: {}", e)))?),
