...
use crate::{LifeError, LifeExecutor, LifeModelTrait};
use sea_query::{
    ColumnDef, Iden, IndexCreateStatement, IndexDropStatement, IntoIden, SchemaName, Table,
    TableAlterStatement, TableCreateStatement, TableDropStatement, TableName,
};
use std::fmt::Display;
...
impl<'a> SchemaManager<'a> {
    ...
    pub fn rename_column<T: Display>(
        &self,
        table: T,
        old_name: &str,
        new_name: &str,
