...
mod tests {
    ...
    fn test_f32_value_type() {
        ...
        assert!(extracted
            .map(|v: f32| (v - 3.14).abs() < f32::EPSILON)
            .unwrap_or(false));
    ...
    fn test_f64_value_type() {
        ...
        assert!(extracted
            .map(|v: f64| (v - 3.14).abs() < f64::EPSILON)
            .unwrap_or(false));
    ...
    fn test_option_u8_null_handling() {
        ...
        assert_eq!(
            extracted,
            Some(None),
            "Option<u8>::from_value() should handle null correctly"
        );
        ...
        assert_eq!(
            extracted,
            Some(None),
            "Value::SmallInt(None) should be recognized as null for Option<u8>"
        );
    }
    ...
    fn test_option_u16_null_handling() {
        ...
        assert_eq!(
            extracted,
            Some(None),
            "Option<u16>::from_value() should handle null correctly"
        );
        ...
        assert_eq!(
            extracted,
            Some(None),
            "Value::Int(None) should be recognized as null for Option<u16>"
        );
    }
    ...
    fn test_option_u32_null_handling() {
        ...
        assert_eq!(
            extracted,
            Some(None),
            "Option<u32>::from_value() should handle null correctly"
        );
        ...
        assert_eq!(
            extracted,
            Some(None),
            "Value::BigInt(None) should be recognized as null for Option<u32>"
        );
    }
}
