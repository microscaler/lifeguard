...
pub fn derive_life_model(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        // In SeaORM, Entity is a unit struct that users define separately.
        // In our case, we generate it from the struct name.
        // This is a unit struct (no fields) that represents the table/entity.
        pub struct Entity;
        ...
        // Following SeaORM's pattern: Entity must implement Default for query building
        ...
        // Following SeaORM's EntityName pattern - this is generated by the macro
