...
#[proc_macro_derive(LifeRecord, attributes(table_name, primary_key, column_name, column_type, default_value, default_expr, renamed_from, unique, indexed, nullable, auto_increment, enum_name, skip, soft_delete, auto_timestamp, lifecycle_hook, has_many, belongs_to, has_one))]
