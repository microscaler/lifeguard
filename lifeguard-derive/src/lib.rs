...
#[proc_macro_derive(LifeModel, attributes(table_name, schema_name, primary_key, column_name, column_type, default_value, default_expr, renamed_from, unique, indexed, nullable, auto_increment, enum_name, skip))]
