//! Test that malformed `map_from` attribute causes compile error
//!
//! This test verifies that when `map_from = 456` (integer instead of string) is used,
...
// ERROR: map_from = 456 should be a string like map_from = "name"
#[derive(DeriveTryIntoModel)]
#[lifeguard(model = "UserModel")]
struct CreateUserRequest {
    #[lifeguard(map_from = 456)]
    user_name: String,
}
