...
#[cfg(test)]
mod tests {
    use super::{Column, Entity, PrimaryKey, UserModel, UserRecord};
    ...
    fn test_primary_key_trait_auto_increment_false() {
        ...
        assert_eq!(
            pk.auto_increment(),
            false,
            "Primary key without #[auto_increment] should return false"
        );
    }
    ...
    fn test_primary_key_arity_single() {
        ...
        assert_eq!(
            ...
            "Single primary key should return Single arity"
        );
    }
    ...
    mod option_pk_entity {
        use lifeguard::{PrimaryKeyToColumn, PrimaryKeyTrait};
    ...
    mod auto_inc_pk_entity {
        ...
        fn test_auto_increment_primary_key_true() {
            ...
            assert_eq!(
                pk.auto_increment(),
                true,
                "Primary key with #[auto_increment] should return true"
            );
        }
    ...
    mod composite_pk_entity {
        ...
        fn test_composite_primary_key_arity() {
            ...
            assert_eq!(
                ...
                "2-column composite primary key should return Tuple2 arity"
            );
        }
    }
    ...
    mod mixed_auto_inc_composite_pk_entity {
        ...
        fn test_mixed_auto_increment_composite_primary_key_arity_with_auto_inc() {
            ...
            assert_eq!(
                arity,
                PrimaryKeyArity::Tuple2,
                "Arity should be Tuple2 regardless of auto_increment settings"
            );
            ...
            assert_eq!(
                pk2.auto_increment(),
                false,
                "Second key does not have auto_increment"
            );
        }
    }
    ...
    mod tuple3_composite_pk_entity {
        ...
        fn test_tuple3_composite_primary_key_arity() {
            ...
            assert_eq!(
                ...
                "3-column composite primary key should return Tuple3 arity"
            );
        }
    }
    ...
    mod tuple4_composite_pk_entity {
        ...
        fn test_tuple4_composite_primary_key_arity() {
            ...
            assert_eq!(
                arity,
                PrimaryKeyArity::Tuple4,
                "4-column composite primary key should return Tuple4 arity"
            );
        }
    }
    ...
    mod tuple5_composite_pk_entity {
        ...
        fn test_tuple5_composite_primary_key_arity() {
            ...
            assert_eq!(
                arity,
                PrimaryKeyArity::Tuple5,
                "5-column composite primary key should return Tuple5 arity"
            );
        }
    }
    ...
    mod tuple6plus_composite_pk_entity {
        ...
        fn test_tuple6plus_composite_primary_key_arity() {
            ...
            assert_eq!(
                ...
                "6+ column composite primary key should return Tuple6Plus arity"
            );
        }
    }
    ...
    mod mixed_type_composite_pk_entity {
        ...
        fn test_mixed_type_composite_primary_key_arity() {
            ...
            assert_eq!(
                arity,
                PrimaryKeyArity::Tuple2,
                "2-column mixed type composite primary key should return Tuple2 arity"
            );
        }
    ...
    mod option_composite_pk_entity {
        use lifeguard::{
            PrimaryKeyArity, PrimaryKeyArityTrait, PrimaryKeyToColumn, PrimaryKeyTrait,
        };
        use lifeguard_derive::LifeModel;
        ...
        fn test_option_composite_primary_key_arity() {
            ...
            assert_eq!(
                arity,
                PrimaryKeyArity::Tuple2,
                "2-column composite primary key with Option types should return Tuple2 arity"
            );
        }
    ...
    fn test_model_trait_get() {
        ...
        match email_value {
            ...
            _ => panic!(
                "Expected String(Some(\"test@example.com\")), got {:?}",
                email_value
            ),
        }
    }
    ...
    fn test_model_trait_set() {
        ...
        let result = model.set(
            Column::Name,
            Value::String(Some("Updated Name".to_string())),
        );
        assert!(result.is_ok());
        ...
        let result = model.set(
            Column::Email,
            Value::String(Some("updated@example.com".to_string())),
        );
        assert!(result.is_ok());
    ...
    fn test_model_trait_get_value_type() {
        ...
        assert_eq!(
            name_type,
            Some("String"),
            "Expected type 'String' for name column"
        );
        ...
        assert_eq!(
            email_type,
            Some("String"),
            "Expected type 'String' for email column"
        );
    }
    ...
    fn test_model_trait_get_value_type_with_options() {
        ...
        assert_eq!(
            name_type,
            Some("Option<String>"),
            "Expected type 'Option<String>' for name column"
        );
        ...
        assert_eq!(
            age_type,
            Some("Option<i32>"),
            "Expected type 'Option<i32>' for age column"
        );
        ...
        assert_eq!(
            active_type,
            Some("Option<bool>"),
            "Expected type 'Option<bool>' for active column"
        );
    }
    ...
    fn test_model_trait_set_null_for_non_option() {
        ...
        assert!(
            result.is_err(),
            "Setting None for non-Option field should error"
        );
    ...
    fn test_model_trait_set_type_mismatch() {
        ...
        assert!(
            result.is_err(),
            "Setting i64 value to i32 field should error"
        );
        ...
        assert!(
            result.is_err(),
            "Setting String value to i32 field should error"
        );
        ...
        assert!(
            result.is_err(),
            "Setting Bool value to String field should error"
        );
    }
    ...
    fn test_model_trait_option_get_none() {
        use super::option_tests::{Column, Entity, UserWithOptions, UserWithOptionsModel};
        ...
        match name_value {
            Value::String(None) => (),
            _ => panic!(
                "Expected String(None) for None Option<String>, got {:?}",
                name_value
            ),
        }
        ...
        match age_value {
            Value::Int(None) => (),
            _ => panic!(
                "Expected Int(None) for None Option<i32>, got {:?}",
                age_value
            ),
        }
        ...
        match active_value {
            Value::Bool(None) => (),
            _ => panic!(
                "Expected Bool(None) for None Option<bool>, got {:?}",
                active_value
            ),
        }
    }
    ...
    fn test_model_trait_json_get() {
        ...
        match preferences_value {
            Value::Json(None) => (),
            _ => panic!(
                "Expected Json(None) for None Option<serde_json::Value>, got {:?}",
                preferences_value
            ),
        }
    }
    ...
    fn test_model_trait_json_set_invalid_type() {
        ...
        let result = model.set(Column::Metadata, Value::String(Some("invalid".to_string())));
        assert!(
            result.is_err(),
            "Setting non-JSON value to JSON field should error"
        );
    }
    ...
    fn test_model_trait_numeric_set_type_mismatch() {
        ...
        assert!(model
            .set(Column::U16Field, Value::BigInt(Some(1000)))
            .is_err());

        // Wrong type for f32 (should be Float, not Double)
        assert!(model
            .set(Column::F32Field, Value::Double(Some(3.14)))
            .is_err());

        // Wrong type for f64 (should be Double, not Float)
        assert!(model
            .set(Column::F64Field, Value::Float(Some(2.71828)))
            .is_err());

        // String to numeric (should error)
        assert!(model
            .set(Column::U8Field, Value::String(Some("invalid".to_string())))
            .is_err());
    }
    ...
    fn test_model_trait_option_numeric_set_some() {
        ...
        // Test u8
        assert!(model
            .set(Column::U8Field, Value::SmallInt(Some(42)))
            .is_ok());
        ...
        // Test u32
        assert!(model
            .set(Column::U32Field, Value::BigInt(Some(100000)))
            .is_ok());
        assert_eq!(model.u32_field, Some(100000));

        // Test u64
        assert!(model
            .set(Column::U64Field, Value::BigInt(Some(10000000000)))
            .is_ok());
        assert_eq!(model.u64_field, Some(10000000000));

        // Test f32
        assert!(model
            .set(Column::F32Field, Value::Float(Some(3.14)))
            .is_ok());
        assert!(model
            .f32_field
            .map(|v| (v - 3.14).abs() < 0.001)
            .unwrap_or(false));

        // Test f64
        assert!(model
            .set(Column::F64Field, Value::Double(Some(2.71828)))
            .is_ok());
        assert!(model
            .f64_field
            .map(|v| (v - 2.71828).abs() < 0.00001)
            .unwrap_or(false));
    }
    ...
    fn test_model_trait_option_numeric_unsigned_range_validation() {
        ...
        assert!(
            error.to_string().contains("range 0..=255"),
        ...
        let error = result.unwrap_err();
        assert!(
            error.to_string().contains("range 0..=65535"),
            "Error should mention valid range"
        );
        ...
        let error = result.unwrap_err();
        assert!(
            error.to_string().contains("range 0..=4294967295"),
            "Error should mention valid range"
        );
        ...
        assert!(model
            .set(Column::U32Field, Value::BigInt(Some(4294967295i64)))
            .is_ok());
...
mod active_model_trait_tests {
    ...
    fn test_active_model_trait_set_works_implementation() {
        ...
        assert!(
            result.is_err(),
            "set() should return error for invalid type"
        );
        let error = result.unwrap_err();
        assert!(
    ...
    fn test_active_model_trait_get_with_option_fields() {
        ...
        assert!(record
            .get(<Entity as LifeModelTrait>::Column::Name)
            .is_some());
    }
    ...
    fn test_active_model_trait_take_none_field() {
        ...
        assert!(
            name_value.is_some(),
            "Name should be returned even if it was just set"
        );
        ...
        assert!(
            !record.dirty_fields().contains(&"name".to_string()),
            "Name should not be in dirty fields after take"
        );
    }
    ...
    fn test_active_model_trait_reset_empty_record() {
        ...
        assert!(
            record.dirty_fields().is_empty(),
            "Empty record should stay empty after reset"
        );
    }
    ...
    fn test_active_model_trait_reset_partial_fields() {
        ...
        assert!(
            record.dirty_fields().is_empty(),
            "All fields should be cleared after reset"
        );
    }
    ...
    fn test_active_model_trait_reset_after_take() {
        ...
        assert!(
            record.dirty_fields().is_empty(),
            "All fields should be cleared after reset, even after take"
        );
    }
    ...
    fn test_record_with_option_fields_not_double_wrapped() {
        ...
        use super::option_tests::{
            Column, Entity, UserWithOptions, UserWithOptionsModel, UserWithOptionsRecord,
        };
        ...
        assert!(
            name_value.is_some(),
            "get() should return Some(Value) for Option<String> field"
        );
        match name_value.unwrap() {
            sea_query::Value::String(Some(v)) => assert_eq!(v, "John"),
        ...
        assert!(
            age_value.is_some(),
            "get() should return Some(Value) for Option<i32> field"
        );
        ...
        assert!(
            active_value.is_some(),
            "get() should return Some(Value) for Option<bool> field"
        );
    ...
    fn test_record_with_option_fields_set_works() {
        ...
        use super::option_tests::{Column, Entity, UserWithOptions, UserWithOptionsRecord};
        use lifeguard::LifeModelTrait;
        ...
        assert!(
            result.is_ok(),
            "set() should work for Option<String> field with Some value"
        );
        ...
        assert!(
            result.is_ok(),
            "set() should work for Option<String> field with None value"
        );
        ...
        assert!(
            name_value.is_none(),
            "get() should return None when Option<String> field is set to None (becomes unset)"
        );
    }
    ...
    fn test_record_with_option_fields_none_values() {
        ...
        assert!(
            name_value.is_none(),
            "get() should return None for unset Option<String> field"
        );

        let age_value = record.get(<Entity as LifeModelTrait>::Column::Age);
        assert!(
            age_value.is_none(),
            "get() should return None for unset Option<i32> field"
        );

        let active_value = record.get(<Entity as LifeModelTrait>::Column::Active);
        assert!(
            active_value.is_none(),
            "get() should return None for unset Option<bool> field"
        );
    ...
    fn test_get_returns_none_for_unset_fields() {
        ...
        assert!(
            id_value.is_none(),
            "get() should return None for unset id field"
        );

        let name_value = record.get(<Entity as LifeModelTrait>::Column::Name);
        assert!(
            name_value.is_none(),
            "get() should return None for unset name field"
        );
    ...
    fn test_get_returns_some_for_set_fields() {
        ...
        assert!(
            id_value.is_some(),
            "get() should return Some(Value) for set id field"
        );
        match id_value.unwrap() {
            sea_query::Value::Int(Some(v)) => assert_eq!(v, 42),
        ...
        assert!(
            email_value.is_some(),
            "get() should return Some(Value) for set email field"
        );
    ...
    fn test_get_with_option_fields_set_to_some() {
        ...
        assert!(
            name_value.is_some(),
            "get() should return Some(Value) for set Option<String> field"
        );
        match name_value.unwrap() {
        ...
        assert!(
            age_value.is_some(),
            "get() should return Some(Value) for set Option<i32> field"
        );
        match age_value.unwrap() {
        ...
        assert!(
            active_value.is_some(),
            "get() should return Some(Value) for set Option<bool> field"
        );
        match active_value.unwrap() {
            sea_query::Value::Bool(Some(v)) => assert_eq!(v, true),
    ...
    fn test_get_with_option_fields_set_to_none() {
        ...
        assert!(
            age_value.is_none(),
            "get() should return None when Option<i32> field is set to None (becomes unset)"
        );
    }
    ...
    fn test_active_model_to_json_with_unset_required_fields() {
        ...
        let json = record
            .to_json()
            .expect("to_json() should succeed even with unset required fields");
        ...
        assert_eq!(
            obj.get("email"),
            None,
            "email should not be in JSON (unset)"
        );
    ...
    fn test_active_model_to_json_empty_record() {
        ...
        let json = record
            .to_json()
            .expect("to_json() should succeed on empty record");

        assert!(json.is_object(), "JSON should be an object");
        let obj = json.as_object().unwrap();
        assert!(
            obj.is_empty(),
            "JSON should be empty when no fields are set"
        );
    }
    ...
    fn test_json_from_json_with_null_for_required_field() {
        ...
        assert!(
            result.is_err(),
            "from_json() should fail when null provided for required field"
        );
    }
    ...
    fn test_json_with_large_values() {
        ...
        let json = record
            .to_json()
            .expect("to_json() should handle large values");
    ...
    fn test_json_with_special_characters() {
        ...
        let json = record
            .to_json()
            .expect("to_json() should handle special characters");
        let restored =
            UserRecord::from_json(json).expect("from_json() should handle special characters");
    ...
    fn test_json_with_nan_and_infinity() {
        ...
        use float_tests::{Entity, FloatFields, FloatFieldsRecord};
        use lifeguard::LifeModelTrait;
        use serde_json::json;
        ...
        record
            .set(
                <float_tests::Entity as LifeModelTrait>::Column::F32Field,
                sea_query::Value::Float(Some(f32::NAN)),
            )
        ...
        assert_eq!(
            obj.get("f32_field"),
            Some(&json!("NaN")),
            "NaN should be serialized as string"
        );
        ...
        record
            .set(
                <float_tests::Entity as LifeModelTrait>::Column::F32Field,
                sea_query::Value::Float(Some(f32::INFINITY)),
            )
            .expect("set should succeed");
        let json = record
            .to_json()
            .expect("to_json() should succeed with infinity");
        let obj = json.as_object().unwrap();
        assert_eq!(
            obj.get("f32_field"),
            Some(&json!("Infinity")),
            "Positive infinity should be serialized as string"
        );
        ...
        record
            .set(
                <float_tests::Entity as LifeModelTrait>::Column::F32Field,
                sea_query::Value::Float(Some(f32::NEG_INFINITY)),
            )
            .expect("set should succeed");
        let json = record
            .to_json()
            .expect("to_json() should succeed with negative infinity");
        let obj = json.as_object().unwrap();
        assert_eq!(
            obj.get("f32_field"),
            Some(&json!("-Infinity")),
            "Negative infinity should be serialized as string"
        );

        // Test NaN for f64
        record
            .set(
                <float_tests::Entity as LifeModelTrait>::Column::F64Field,
                sea_query::Value::Double(Some(f64::NAN)),
            )
            .expect("set should succeed");
        let json = record.to_json().expect("to_json() should succeed with NaN");
        let obj = json.as_object().unwrap();
        ...
        record
            .set(
                <float_tests::Entity as LifeModelTrait>::Column::F64Field,
                sea_query::Value::Double(Some(f64::INFINITY)),
            )
            .expect("set should succeed");
        let json = record
            .to_json()
        ...
        record
            .set(
                <float_tests::Entity as LifeModelTrait>::Column::F64Field,
                sea_query::Value::Double(Some(f64::NEG_INFINITY)),
            )
            .expect("set should succeed");
        let json = record
            .to_json()
        ...
        record
            .set(
                <float_tests::Entity as LifeModelTrait>::Column::F32Field,
                sea_query::Value::Float(Some(3.14)),
            )
            .expect("set should succeed");
        record
            .set(
                <float_tests::Entity as LifeModelTrait>::Column::F64Field,
                sea_query::Value::Double(Some(2.71828)),
            )
            .expect("set should succeed");
        let json = record
            .to_json()
            .expect("to_json() should succeed with normal numbers");
        let obj = json.as_object().unwrap();
        // Normal numbers should be JSON numbers, not strings
        assert!(
            obj.get("f32_field").unwrap().is_number(),
            "Normal f32 should be a number"
        );
        assert!(
            obj.get("f64_field").unwrap().is_number(),
            "Normal f64 should be a number"
        );
    }
    ...
    fn test_json_roundtrip_with_nan_and_infinity() {
        ...
        let restored = FloatFieldsRecord::from_json(json)
            .expect("from_json() should succeed with custom deserializers");
        ...
        match restored_f32 {
            Some(sea_query::Value::Float(Some(v))) => {
                assert!(v.is_nan(), "f32 NaN should be preserved")
            }
        ...
        match restored_f64 {
            Some(sea_query::Value::Double(Some(v))) => {
                assert!(
                    ...
                    "f64 Infinity should be preserved"
                );
            }
        ...
        let restored_f32_2 =
            restored2.get(<float_tests::Entity as LifeModelTrait>::Column::F32Field);
        match restored_f32_2 {
            Some(sea_query::Value::Float(Some(v))) => {
                assert!(
                    v.is_infinite() && v.is_sign_negative(),
                    "f32 -Infinity should be preserved"
                );
            }
    ...
    fn test_json_with_option_float_nan_and_infinity() {
        ...
        record
            .set(
                <option_float_tests::Entity as LifeModelTrait>::Column::F32Field,
                sea_query::Value::Float(Some(f32::NAN)),
            )
            .expect("set should succeed");
        let json = record.to_json().expect("to_json() should succeed");
        ...
        assert_eq!(
            obj.get("f32_field"),
            Some(&json!("NaN")),
            "Option<f32> NaN should be serialized as string"
        );

        // Test Option<f64> with infinity
        record
            .set(
                <option_float_tests::Entity as LifeModelTrait>::Column::F64Field,
                sea_query::Value::Double(Some(f64::INFINITY)),
            )
            .expect("set should succeed");
        let json = record.to_json().expect("to_json() should succeed");
        ...
        assert_eq!(
            obj.get("f64_field"),
            Some(&json!("Infinity")),
            "Option<f64> infinity should be serialized as string"
        );
        ...
        assert!(
            !obj.contains_key("f32_field") || obj.get("f32_field") == Some(&json!(null)),
            "Option None should be null or omitted"
        );
    }
    ...
    fn test_nan_comparison_edge_cases() {
        ...
        match (&val1, &val2) {
            (Some(sea_query::Value::Float(Some(v1))), Some(sea_query::Value::Float(Some(v2)))) => {
                ...
                assert_ne!(
                    v1, v2,
                    "NaN != NaN in Rust (IEEE 754 standard - this is expected behavior)"
                );
                ...
                assert_ne!(
                    val1, val2,
                    "Value::Float(Some(NaN)) != Value::Float(Some(NaN)) because NaN != NaN"
                );
            }
    ...
    fn test_mixed_normal_and_special_float_values() {
        ...
        record
            .set(
                <Entity as LifeModelTrait>::Column::F32Field,
                sea_query::Value::Float(Some(f32::INFINITY)),
            )
            .expect("set should succeed");
        record
            .set(
                <Entity as LifeModelTrait>::Column::F64Field,
                sea_query::Value::Double(Some(2.71828)),
            )
            .expect("set should succeed");
        ...
        assert_eq!(
            obj.get("f32_field"),
            Some(&json!("Infinity")),
            "Infinity should be serialized as string"
        );
        assert!(
            obj.get("f64_field").unwrap().is_number(),
            "Normal f64 should be a number"
    ...
    fn test_json_roundtrip_with_column_name_attribute() {
        ...
        assert!(
            json_obj.contains_key("user_name"),
            "JSON should contain 'user_name' key (column name)"
        );
        assert!(
            !json_obj.contains_key("firstName"),
            "JSON should NOT contain 'firstName' key (field name)"
        );
        assert!(
            json_obj.contains_key("email_address"),
            "JSON should contain 'email_address' key (column name)"
        );
        assert!(
            !json_obj.contains_key("email"),
            "JSON should NOT contain 'email' key (field name)"
        );

        // JSON -> Record (should deserialize using column names via serde rename)
        let restored =
            UserWithRenamedColumnsRecord::from_json(json).expect("from_json() should succeed");
    ...
    fn test_active_model_behavior_default_implementations() {
        ...
        impl lifeguard::ActiveModelTrait for TestRecordDefault {
            ...
            fn get(
                &self,
                column: <Entity as lifeguard::LifeModelTrait>::Column,
            ...
            fn insert(
                &self,
                _executor: &dyn lifeguard::LifeExecutor,
    ...
    fn test_active_model_behavior_trait_bounds() {
        ...
        impl ActiveModelTrait for TestRecordBounds {
            ...
            fn get(
                &self,
                _column: <Entity as lifeguard::LifeModelTrait>::Column,
            ) -> Option<sea_query::Value> {
                None
            }
    ...
    fn test_active_model_behavior_hooks_can_modify_record() {
        ...
        impl ActiveModelBehavior for ModifyingRecord {
            fn before_insert(&mut self) -> Result<(), lifeguard::ActiveModelError> {
                ...
                self.set(
                    <Entity as LifeModelTrait>::Column::Name,
                    sea_query::Value::String(Some("Modified in before_insert".to_string())),
                )?;
                Ok(())
            }
            ...
            fn before_update(&mut self) -> Result<(), lifeguard::ActiveModelError> {
                ...
                self.set(
                    <Entity as LifeModelTrait>::Column::Name,
                    sea_query::Value::String(Some("Modified in before_update".to_string())),
                )?;
                Ok(())
            }
        }
    ...
    fn test_set_edge_case_none_for_non_nullable_field() {
        ...
        assert!(
            result.is_ok(),
            "set() should allow None for non-nullable fields"
        );
        let err = record
            .to_model()
            .expect_err("to_model should fail when name unset");
    ...
    fn test_set_edge_case_valid_type_conversions() {
        ...
        assert!(
            result.is_ok(),
            "set() should work for String(None) -> Option<String>"
        );
    }
    ...
    fn test_entity_insert_method_exists() {
        ...
        // This is a compile-time check
        use lifeguard::{ActiveModelError, ActiveModelTrait, LifeExecutor, LifeModelTrait};

        fn _verify_insert_signature<
            E: LifeModelTrait,
            AM: ActiveModelTrait<Model = E::Model>,
            Ex: LifeExecutor,
        >(
            _entity: E,
            _active_model: AM,
